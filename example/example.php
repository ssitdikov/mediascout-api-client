...
use Ssitdikov\MediascoutApiClient\Request\Dictionary\GetDictionaryRequest;
...
$query = new GetDictionaryQuery($dictionary);

$request = new GetDictionaryRequest($query);
